        ...
        <section className="grid gap-12 px-5 py-20 md:grid-cols-2 md:gap-20 md:px-10 md:py-28">
          <Reveal>
            <p className="text-xl leading-relaxed text-ink/80 md:text-2xl">
              ...
              four people in Austin, still independent, and still convinced
          ...
          <Reveal delay={0.1}>
            ...
            <p className="mt-6 leading-relaxed text-ink/70">
              ...
              systems at Austin Community College, running a monthly critique
              night for local designers, and arguing about typography over
              breakfast tacos.
            </p>
          </Reveal>
        </section>
